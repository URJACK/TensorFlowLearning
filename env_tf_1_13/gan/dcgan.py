...
for e in range(5):
    ...
    while num_examples < train_set.num_examples:
        ...
        loss_d, loss_g, fake_imgs, _ = sess.run([d_total_error, g_total_error, inputs_fake, dc_train_generator],
...
saver.save(sess, os.path.abspath(os.path.dirname(__file__)) + "\\model\\dcgan.ckpt")
