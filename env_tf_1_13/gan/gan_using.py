...
sess = tf.Session()
saver = tf.train.import_meta_graph(os.path.abspath(os.path.dirname(__file__)) + '\\model\\gan.ckpt.meta')
saver.restore(sess, os.path.abspath(os.path.dirname(__file__)) + "\\model\\gan.ckpt")
